...
function setup() {
    ...
    Gun1 = createSprite(Guard.y, Guard.x-20, 15, 7);
    Gun1.shapeColor = color("white");

    Gun2 = createSprite(Guard.y, Guard.x-20, 18,8);
    Gun2.shapeColor = color("yello");

    Gun3 = createSprite(Guard.y, Guard.x-20, 22, 12);
    Gun3.shapeColor = color("red");
...
function draw() {
    ...
    // Zombie = createSprite(random(1000, 800), random(250, 650), 30, 30);
